...
def handle_left(mqtt_client, left_speed_entry, right_speed_entry):
    mqtt_client.send_message("turn_left_until_stop", [int(left_speed_entry.get()), int(right_speed_entry.get())])

def handle_right(mqtt_client, left_speed_entry, right_speed_entry):
    mqtt_client.send_message("turn_right_until_stop", [int(left_speed_entry.get()), int(right_speed_entry.get())])

def handle_backward(mqtt_client, left_speed_entry, right_speed_entry):
    mqtt_client.send_message("drive_forward", [-1*int(left_speed_entry.get()), -1*int(right_speed_entry.get())])
